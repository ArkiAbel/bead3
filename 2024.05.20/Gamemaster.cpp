...
void Gamemaster::event_loop(std::vector<std::string> b,std::vector<int>sz,std::vector<Reserved>&rl,std::vector<Reserved>&rr,
    ...
    std::function<void(bool &,bool,bool &,bool&,std::string &,int,int,std::vector<std::string>,std::vector<int>,std::vector<Reserved>&)> leftgrid_hover_getshot;
        leftgrid_hover_getshot = [](bool &active_2,bool click,bool &IsGame,bool &IsTurn,std::string &Player,int epos_x,int epos_y,std::vector<std::string>b,std::vector<int>sz,std::vector<Reserved>&sol){Reserved res; for (int i = 0; i < 10; i++) {
            //nagy negyzet
    ...
    std::function<void(bool,std::string &,int,int)> player2_attack;
        player2_attack = [](bool active_2,std::string &Player,int epos_x,int epos_y){Reserved res; for (int i = 0; i < 10; i++) {
            for (int j = 0; j < 10; j++) {
                if (epos_x > ((YY-200)/10)*j+101 && epos_x < ((YY-200)/10)*j+101+((YY-200)/10) &&
                    epos_y > ((YY-200)/10)*i+101 && epos_y < ((YY-200)/10)*i+101+((YY-200)/10)) {
                    if (active_2 && Player == "masodik") {
                        gout << color(150,150,150) << move_to(((YY-200)/10)*j+101,((YY-200)/10)*i+101) <<
                        box((YY-200)/10 - 2,(YY-200)/10 - 2);
                        gout << move_to(((YY-200)/10)*(j-1)+101,((YY-200)/10)*(i-1)+101) <<
                        box((YY-200)/10 - 2,(YY-200)/10 - 2);
                        gout << move_to(((YY-200)/10)*(j+1)+101,((YY-200)/10)*(i+1)+101) <<
                        box((YY-200)/10 - 2,(YY-200)/10 - 2);
                        gout << move_to(((YY-200)/10)*(j+1)+101,((YY-200)/10)*(i-1)+101) <<
    ...
    std::function<void(std::string,int,int,bool,bool &,bool &,bool &)> widgets;
        widgets = [](std::string Player,int epos_x,int epos_y,bool click,bool &active_1,bool &active_2,bool &active_3){
        if (Player == "elso") {
            if (epos_x >= 300 && epos_x <= 350 && epos_y >= 50 && epos_y <= 100) {
                ...
                << color(255,0,0) << move_to(325,50) << text(".");
                if (click) {
                    active_1 = true;
                    active_2 = false;
                    active_3 = false;
            ...
            if (epos_x >= 360 && epos_x <= 410 && epos_y >= 50 && epos_y <= 100) {
                ...
                << color(255,0,0) << move_to(385,50) << text("x");
                if (click) {
                    active_1 = false;
                    active_2 = true;
                    active_3 = false;
            ...
            if (epos_x >= 420 && epos_x <= 460 && epos_y >= 50 && epos_y <= 100) {
                ...
                << color(255,0,0) << move_to(445,50) << text("+");
                if (click) {
                    active_1 = false;
                    active_2 = false;
                    active_3 = true;
        ...
        //masodik
            ...
            if (epos_x >= XX-350 && epos_x <= XX-300 && epos_y >= 50 && epos_y <= 100) {
                //elso
                gout << color(0,0,255) << move_to(XX-350,50) << box(50,40) << color(200,155,255) << move_to(XX-351,51) << box(48,38);
                if (click) {
                    active_1 = true;
                    active_2 = false;
                    active_3 = false;
                ...
                gout << color(0,0,255) << move_to(XX-350,50) << box(50,40) << color(200,255,255) << move_to(XX-351,51) << box(48,38);
            }
            if (active_1) {
                gout << color(0,0,255) << move_to(XX-295-50,45) << box(60,50) << color(200,155,255) << move_to(XX-301-50,51) << box(48,38);
            }
            //kozepso
            if (epos_x >= XX-410 && epos_x <= XX-360 && epos_y >= 50 && epos_y <= 100) {
                gout << color(0,0,255) << move_to(XX-360-50,50) << box(50,40) << color(200,155,255) << move_to(XX-361-50,51) << box(48,38);
                if (click) {
                    active_1 = false;
                    active_2 = true;
                    active_3 = false;
                ...
                gout << color(0,0,255) << move_to(XX-360-50,50) << box(50,40) << color(200,255,255) << move_to(XX-361,51) << box(48,38);
            }
            if (active_2) {
                gout << color(0,0,255) << move_to(XX-355-50,45) << box(60,50) << color(200,155,255) << move_to(XX-361,51) << box(48,38);
            }
            //utolso
            if (epos_x >= 470 && epos_x <= 420 && epos_y >= 50 && epos_y <= 100) {
                gout << color(0,0,255) << move_to(XX-420-50,50) << box(50,40) << color(200,155,255) << move_to(XX-421-50,51) << box(48,38);
                if (click) {
                    active_1 = false;
                    active_2 = false;
                    active_3 = true;
                ...
                gout << color(0,0,255) << move_to(XX-420-50,50) << box(50,40) << color(200,255,255) << move_to(XX-421-50,51) << box(48,38);
            }
            if (active_3) {
                gout << color(0,0,255) << move_to(XX-415-50,45) << box(60,50) << color(200,155,255) << move_to(XX-421-50,51) << box(48,38);
            }
        }
        };
    ...
    while (gin >> ev && ev.keycode != key_escape) {
        ...
        if (IsMenu) {
            ...
            game_screen_reset();
            leftgrid_hover_getshot(active_2,click,IsGame,IsTurn,Player,epos_x,epos_y,b,sz,sol);
            ...
            player2_attack(active_2,Player,epos_x,epos_y);
            player_tags();
            ...
            widgets(Player,epos_x,epos_y,click,active_1,active_2,active_3);
            cursor_refresh(OnShip,epos_x,epos_y);
            screen_refresh();
        }
